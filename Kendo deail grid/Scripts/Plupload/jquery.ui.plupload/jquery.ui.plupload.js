					...
					'<div class="plupload_content">' +
						...
						'<tr class="ui-widget-header ui-widget-content plupload_filelist_footer">' +
							'<td class="plupload_cell plupload_file_name">' +
								...
								'<div class="plupload_buttons plupload_hidden"><!-- Visible -->' +
									'<a class="plupload_button plupload_add plupload_hidden">' + _('Add Files') + '</a>&nbsp;' +
									'<a class="plupload_button plupload_start plupload_hidden">' + _('Start Upload') + '</a>&nbsp;' +
        ...
        _handleFileStatus: function (file) {
            ...
            switch (file.status) {
                case plupload.DONE:
                    ...
                    iconClass = 'ui-icon-green ui-icon-circle-check';
                    break;
                ...
                case plupload.QUEUED:
                    ...
                    iconClass = 'ui-icon-red ui-icon-circle-close';
                    break;
