    ...
    plupload.runtimes.Html5 = plupload.addRuntime("html5", {
        ...
        */
        init: function (uploader, callback) {
            ...
            function addSelectedFiles(native_files, native_items) {
                ...
                for (i = 0; i < native_files.length; i++) {
                    ...
                    var currentFile = new plupload.File(id, file.fileName || file.name, file.fileSize || file.size);  // fileName / fileSize depricated
                    if (!currentFile.nativeFile) {
                        plupload.File.prototype.nativeFile = file;
                        currentFile.nativeFile = file;
                    } else {
                        currentFile.nativeFile = file;
                    }
                    ...
                    if (native_items) {
                        if (!currentFile.isDirectory) {
                            if (native_items[i].webkitGetAsEntry().isDirectory) {
                                plupload.File.prototype.isDirectory = true;
            ...
            uploader.bind("Init", function (up) {
                ...
                if (browseButton) {
                    var isBrowserIE10 = false;
                    if (global.GetBrowser().browser == 'Explorer' && global.GetBrowser().version == '10') {
                        isBrowserIE10 = true;
                    }
                    var hoverClass = up.settings.browse_button_hover,
                                                activeClass = up.settings.browse_button_active,
                                                topElement = (up.features.triggerDialog || isBrowserIE10) ? browseButton : inputContainer;
                    ...
                    if (up.features.triggerDialog || isBrowserIE10) {
                ...
                if (dropElm) {
                    ...
                    plupload.addEvent(dropElm, 'drop', function (e) {
                        ...
                        if (dataTransfer && dataTransfer.files) {
                            addSelectedFiles(dataTransfer.files, dataTransfer.items);
                        }
